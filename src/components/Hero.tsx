          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <motion.p 
                ...
                className="inline-block px-4 py-2 mt-4 bg-primary/20 backdrop-blur-sm border border-primary/40 rounded-lg text-lg md:text-xl text-primary font-semibold shadow-lg shadow-primary/20"
              >
