...
const blogRvGuide = "stub";
const blogWinterCamping = "stub";
const blogSolarSystem = "stub";
const blogBatteryComparison = "stub";
const blogBmsTechnology = "stub";
const blogVanlifeBuilds = "stub";
const blogMarineInstall = "stub";
const blogChargingTips = "stub";

// Engineering article cover images
const blogEngColdWeather = "stub";
const blogEngParallelBalance = "stub";
const blogEngVoltageUpgrade = "stub";
const blogEngInverterMatch = "stub";
const blogEngMarineCorrosion = "stub";
const blogEngMultiSource = "stub";
const blogEngHighCurrent = "stub";
const blogEngStorageAging = "stub";
const blogEngRandomShutdown = "stub";
const blogEngBluetoothData = "stub";
